...
public class RawApp {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(RawApp.class);
    ...
    // 微信特殊账号
    private List<String> SpecialUsers = Arrays.asList("newsapp", "fmessage", "filehelper", "weibo",
    ...
    public String waitForLogin() {
        ...
        HttpRequest request = HttpRequest.get(url, true, "tip", this.tip, "uuid", this.uuid, "_",
                DateKit.getCurrentUnixTime());
    ...
    public boolean wxInit() {
        ...
        String url = this.base_uri + "/webwxinit?r=" + DateKit.getCurrentUnixTime()
    ...
    public boolean wxStatusNotify() {
        ...
        String url = this.base_uri + "/webwxstatusnotify?lang=zh_CN&pass_ticket="
                + this.pass_ticket;
    ...
    public boolean getContact() {
        ...
        String url = this.base_uri + "/webwxgetcontact?pass_ticket=" + this.pass_ticket + "&skey="
                + this.skey + "&r=" + DateKit.getCurrentUnixTime();
    ...
    public int[] syncCheck() {
        ...
        HttpRequest request = HttpRequest.get(url, true, "r",
                DateKit.getCurrentUnixTime() + StringKit.getRandomNumber(5), "skey", this.skey,
                "uin", this.wxuin, "sid", this.wxsid, "deviceid", this.deviceId, "synckey",
                this.synckey, "_", System.currentTimeMillis()).header("Cookie", this.cookie);
    ...
    public JSONObject webwxsync() {
        ...
        String url = this.base_uri + "/webwxsync?lang=zh_CN&pass_ticket=" + this.pass_ticket
                + "&skey=" + this.skey + "&sid=" + this.wxsid + "&r="
                + DateKit.getCurrentUnixTime();
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        if (null == uuid) {
            ...
            LOGGER.info("[*] 获取联系人成功");
            LOGGER.info("[*] 共有 {} 位联系人", app.ContactList.size());
